...
clean_df %>% 
  ...
  facet_grid(.~arm) +
  labs(
    title = "Comparing Observation for each Subject Over Time \n Between Control and Experimental Group",
    x = "Week",
    y = "Observation Units"
  ) +
...
<img src="p8105_hw5_jl5296_files/figure-markdown_github/unnamed-chunk-4-1.png" width="90%" /> **Comment:** Overall, subjects in the experimental arm show higher observation units over time, on average, than those in the control arm.
